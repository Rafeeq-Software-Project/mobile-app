...
@override
String toString() {
  return 'ResendOtpState.success(email: $email)';
}
...
/// @nodoc
abstract mixin class $SuccessCopyWith<$Res> implements $ResendOtpStateCopyWith<$Res> {
...
@override
String toString() {
  return 'ResendOtpState.failure(error: $error)';
}
